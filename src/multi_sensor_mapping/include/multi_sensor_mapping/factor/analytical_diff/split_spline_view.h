#ifndef MSM_ANALYTICAL_DIFF_SPLIT_SPLINE_VIEW_H
#define MSM_ANALYTICAL_DIFF_SPLIT_SPLINE_VIEW_H

#include "multi_sensor_mapping/factor/analytical_diff/rd_spline_view.h"
#include "multi_sensor_mapping/factor/analytical_diff/so3_spline_view.h"
...
struct SplitSpineView : public So3SplineView, public RdSplineView {
  ...
  static SplineIMUData EvaluateNURBS(
      const int64_t time_ns, double const* const* knots, const Vec3& gravity,
