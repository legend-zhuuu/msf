...
if(multi_sensor_mapping_CONFIG_INCLUDED)
  return()
endif()
set(multi_sensor_mapping_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(multi_sensor_mapping_SOURCE_PREFIX /home/zdy/msf_ws/src/multi_sensor_mapping)
  set(multi_sensor_mapping_DEVEL_PREFIX /home/zdy/msf_ws/src/cmake-build-debug/devel)
  set(multi_sensor_mapping_INSTALL_PREFIX "")
  set(multi_sensor_mapping_PREFIX ${multi_sensor_mapping_DEVEL_PREFIX})
else()
  set(multi_sensor_mapping_SOURCE_PREFIX "")
  set(multi_sensor_mapping_DEVEL_PREFIX "")
  set(multi_sensor_mapping_INSTALL_PREFIX /home/zdy/msf_ws/src/cmake-build-debug/../install)
  set(multi_sensor_mapping_PREFIX ${multi_sensor_mapping_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'multi_sensor_mapping' is deprecated")
...
set(multi_sensor_mapping_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(multi_sensor_mapping_INCLUDE_DIRS "")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Wu Hangyu <wuhangyu.zju@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${multi_sensor_mapping_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'multi_sensor_mapping' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'multi_sensor_mapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(multi_sensor_mapping_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND multi_sensor_mapping_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND multi_sensor_mapping_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT multi_sensor_mapping_NUM_DUMMY_TARGETS)
      set(multi_sensor_mapping_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::multi_sensor_mapping::wrapped-linker-option${multi_sensor_mapping_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR multi_sensor_mapping_NUM_DUMMY_TARGETS "${multi_sensor_mapping_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::multi_sensor_mapping::wrapped-linker-option${multi_sensor_mapping_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND multi_sensor_mapping_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zdy/msf_ws/src/cmake-build-debug/../install/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(multi_sensor_mapping_LIBRARY_DIRS ${lib_path})
      list(APPEND multi_sensor_mapping_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'multi_sensor_mapping'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND multi_sensor_mapping_LIBRARIES ${lib})
    endif()
  endif()
...
set(multi_sensor_mapping_EXPORTED_TARGETS "multi_sensor_mapping_generate_messages_cpp;multi_sensor_mapping_generate_messages_eus;multi_sensor_mapping_generate_messages_lisp;multi_sensor_mapping_generate_messages_nodejs;multi_sensor_mapping_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${multi_sensor_mapping_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 multi_sensor_mapping_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${multi_sensor_mapping_dep}_FOUND)
      find_package(${multi_sensor_mapping_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${multi_sensor_mapping_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(multi_sensor_mapping_INCLUDE_DIRS ${${multi_sensor_mapping_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(multi_sensor_mapping_LIBRARIES ${multi_sensor_mapping_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${multi_sensor_mapping_dep}_LIBRARIES})
  _list_append_deduplicate(multi_sensor_mapping_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(multi_sensor_mapping_LIBRARIES ${multi_sensor_mapping_LIBRARIES})

  _list_append_unique(multi_sensor_mapping_LIBRARY_DIRS ${${multi_sensor_mapping_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(multi_sensor_mapping_EXPORTED_TARGETS ${${multi_sensor_mapping_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "multi_sensor_mapping-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${multi_sensor_mapping_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
